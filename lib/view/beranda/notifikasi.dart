...
class _NotificationScreenState extends State<NotificationScreen> {
  ...
  List<NotificationItem> monthNotifications = [
    NotificationItem(
    ...
    NotificationItem(
      title: 'Event Healthy Club: Yoga Under the Stars',
      content:
          'Jangan lewatkan event spesial kami, Yoga Under the Stars, minggu depan. Daftar sekarang untuk menikmati pengalaman unik di bawah langit malam!',
      date: '05-11-2024 18:00',
      isRead: true,
      route: LatihanScreen(),
    ),
  ];
...
class _NotificationCardState extends State<NotificationCard> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Card(
        color:
            widget.notification.isRead ? Color(0xFF361A4F) : Color(0xFF673296),
        shape:
            RoundedRectangleBorder(borderRadius: BorderRadius.circular(12.0)),
        elevation: 3,
        child: Container(
          constraints:
              BoxConstraints(minHeight: 100.0), // Tinggi minimal yang sama
...
class LatihanScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(child: Text('Latihan Details')),
    );
  }
}
...
class TrainerScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Halaman Trainer'),
      ),
      body: Center(child: Text('Trainer Details')),
    );
  }
}

...
class TinggiBadan extends StatefulWidget {
  final Map? data;
  const TinggiBadan({super.key, this.data});

  @override
  State<TinggiBadan> createState() => _TinggiBadan();
}

class _TinggiBadan extends State<TinggiBadan> {
        ...
        children: [
          ...
          Padding(
            ...
            Container(
              ...
              child: Text(
                "Tinggi Badan Anda $_currentValue cm",
